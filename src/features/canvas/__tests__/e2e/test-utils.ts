...
export async function waitForCanvasReady(page: Page) {
  await page.waitForFunction(() => {
    return window['canvasStage'] !== undefined &&
 ...
 */
export async function getCanvasStage(page: Page): Promise<string> {
  return 'canvasStage';
}
 ...
 */
export async function multiSelect(page: Page, positions: Array<{ x: number; y: number }>) {
 ...
 */
export async function createText(page: Page, x: number, y: number, text: string) {
